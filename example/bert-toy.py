...
if __name__ == "__main__":
    ...
    parser.add_argument("--softmax_hidden_size", type=int, default=64, help="Hidden size for the SoftmaxApprox model")
    ...
    parser.add_argument("--softmax_batch_size", type=int, default=1, help="Batch size for training")
    parser.add_argument("--softmax_lr", type=float, default=0.0001, help="Learning rate for training")
    ...
    softmax_trainer = SoftmaxApproxTrainer(softmax_model, 
